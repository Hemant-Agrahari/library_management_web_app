...
export const fetchUserBorrowedBooks = () => async (dispatch) => {
    ...
    await axios.get(`${import.meta.env.VITE_API_BASE_URL}/borrow/my-borrowed-books`, {
...
export const fetchAllBorrowedBooks = () => async (dispatch) => {
    ...
    await axios.get(`${import.meta.env.VITE_API_BASE_URL}/borrow/borrowed-books-by-users`, {
        withCredentials: true,
    }).then((res) => {
...
export const recordBorrowedBook = (email,id) => async (dispatch) => {
    ...
    await axios.post(`${import.meta.env.VITE_API_BASE_URL}/borrow/record-borrow-book/${id}`, { email }, {
        withCredentials: true,
        headers: {
...
export const returnBorrowedBook = (email,id) => async (dispatch) => {
    ...
    await axios.put(`${import.meta.env.VITE_API_BASE_URL}/borrow/return-borrowed-book/${id}`, { email }, {
        withCredentials: true,
        headers: {
            'Content-Type': 'application/json',
        },
